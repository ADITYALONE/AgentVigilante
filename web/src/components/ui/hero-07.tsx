...
export function Hero07({
  ...
  const titleElement = title && (
    <h1
      className={cn(
        "font-heading text-balance font-normal tracking-tight text-foreground",
        vs.title,
      )}
    >
    ...
    <div className="relative w-full overflow-hidden">
      ...
      >
        ...
        <img
          ...
          alt={landscapeAlt}
          decoding="async"
          className="aspect-[2/1] w-full object-cover object-center outline outline-black/10 sm:aspect-[9/4] dark:brightness-[0.97] dark:saturate-[0.92] dark:outline-white/10"
        />
      </div>
    </div>
  )
