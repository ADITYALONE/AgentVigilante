...
from agent_vigilante.service import (
    install_service,
...
class ServiceRenderTests(unittest.TestCase):
    def test_launchd_contains_headless_flags(self) -> None:
        ...
        self.assertIn("com.agentvigilante.daemon", xml)
    ...
    def test_install_writes_plist_without_load(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            home = Path(tmp)
            with mock.patch("agent_vigilante.service.platform.system", return_value="Darwin"):
            ...
            self.assertIn("agent_vigilante", body)
